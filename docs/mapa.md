...
planilha do comprador ([FABRICANTES ENVIO MAPA.xlsx](FABRICANTES%20ENVIO%20MAPA.xlsx)) é quem
...
Cobre também a formatação que era feita à mão depois do download: além do arquivo bruto, cada
rodada grava um `.xlsx` formatado em `formatado\`, no mesmo layout de
